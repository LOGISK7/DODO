...
export default function Qualifications() {
  ...
  return (
    <section id="qualifications" className="py-24 md:py-32 bg-[var(--bg-primary)] border-t border-[var(--border-subtle)] relative">
      <div className="max-w-[1240px] mx-auto px-6 md:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <Reveal delay={0.1}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-[var(--text-primary)] tracking-tight mb-6">
              Vetting Standards & <span className="font-heading italic text-[var(--accent-cobalt)]">Eligibility Criteria</span>
            </h2>
          </Reveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
          ...
          <Reveal delay={0.15}>
            <div className="h-full p-8 sm:p-10 md:p-12 rounded-sm bg-[var(--bg-card)] border border-[var(--border-cobalt)] shadow-[0_0_30px_rgba(197,160,89,0.08)] relative flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-8">
                  <div className="w-10 h-10 rounded-sm bg-[var(--accent-cobalt)]/10 border border-[var(--accent-cobalt)] flex items-center justify-center text-[var(--accent-cobalt)]">
                    <Users size={20} />
                  </div>
                  <div>
                ...
                <ul className="space-y-6">
                  {perfectFor.map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4">
                      <div className="w-6 h-6 rounded-full bg-[#1A2E1C] border border-[var(--border-subtle)]/40 flex items-center justify-center text-[#22c55e] flex-shrink-0 mt-0.5">
                        <Check size={14} />
                      </div>
                      <p className="text-sm md:text-[15px] text-[var(--text-primary)] leading-relaxed font-sans">
                        {item}
                      </p>
                    </li>
                  ))}
              ...
              <div className="mt-10 pt-6 border-t border-[var(--border-subtle)]">
                <span className="text-xs font-bold uppercase tracking-[0.16em] text-[var(--accent-cobalt)]">
          ...
          <Reveal delay={0.25}>
            <div className="h-full p-8 sm:p-10 md:p-12 rounded-sm bg-[var(--bg-card)] border border-[var(--border-subtle)] relative flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-8">
                  <div className="w-10 h-10 rounded-sm bg-[#ef4444]/10 border border-[var(--border-subtle)]/40 flex items-center justify-center text-[#ef4444]">
                    <ShieldAlert size={20} />
                  </div>
                  <div>
                    <h3 className="font-heading font-bold text-xl sm:text-2xl text-[var(--text-primary)]">
                ...
                <ul className="space-y-6">
                  {notFor.map((item, idx) => (
                    <li key={idx} className="flex items-start gap-4">
                      <div className="w-6 h-6 rounded-full bg-[#2E1A1A] border border-[var(--border-subtle)]/40 flex items-center justify-center text-[#ef4444] flex-shrink-0 mt-0.5">
                        <X size={14} />
                      </div>
