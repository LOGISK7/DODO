...
export default function NarrativeSection() {
  return (
    <section id="the-lie" className="py-24 md:py-32 bg-[#050505] border-t border-[#18181B] relative">
      <div className="max-w-[900px] mx-auto px-6 md:px-8 space-y-24">
        
        {/* Subsection 1: The Trap */}
        <div className="space-y-6">
          <Reveal>
            <span className="text-xs font-bold uppercase tracking-[0.22em] text-[#c5a059] block">
          ...
          <Reveal delay={0.1}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-white leading-tight">
              ...
              <span className="font-serif-accent italic gold-gradient-text">You've Just Fallen Into A Success Prison.</span>
            </h2>
          </Reveal>

          <Reveal delay={0.2}>
            <div className="space-y-5 text-base sm:text-lg text-[#A1A1AA] leading-relaxed font-sans">
              <p>
        ...
        <div className="p-8 md:p-12 rounded-sm bg-[#0E0E10] border border-[#222226] relative space-y-6">
          ...
          <Reveal delay={0.1}>
            <div className="space-y-4 text-base sm:text-lg text-[#A1A1AA] leading-relaxed font-sans">
              <p>
              ...
              <p>
                <strong className="text-white">Here is the unfiltered truth:</strong> Revenue is a drug. Scaling an inefficient model doesn't make you freer; it amplifies your stress. Most founders are simply running on a high-speed treadmill, mistakenly believing the finish line is just “one more million” away.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Reveal delay={0.1}>
            <div className="space-y-5 text-base sm:text-lg text-[#A1A1AA] leading-relaxed font-sans">
              <p>
                Traditional business advisors train founders to fixate solely on the top-line income statement while completely ignoring the one metric that actually provides sovereign freedom: <strong className="text-[#fae19c]">Investable Net Worth</strong>.
              </p>
              <p>
